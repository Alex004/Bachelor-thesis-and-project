...
import com.example.myapplication.QRCode.googlevision.TextScannerProcessor;
...
public class OCRVisionScannerActivity extends AppCompatActivity
        implements ActivityCompat.OnRequestPermissionsResultCallback, IExchangeScannedData {

    private static final String TAG = "QCRVisScannerActivity";
    ...
    private void bindPreviewUseCase() {
        ...
        cameraProvider.bindToLifecycle(/* lifecycleOwner= */ OCRVisionScannerActivity.this,
    ...
    private void bindAnalysisUseCase() {
        ...
        try {
            Log.i(TAG, "Using Text scanner Detector Processor");
            imageProcessor = new TextScannerProcessor(this, this);
        } catch (Exception e) {
    ...
    public void sendScannedCode(String code) {
        ...
        handler.post(() -> {
            if (code != null && !code.isEmpty()) {
                binding.qrcodeRawValue.setText(code);
